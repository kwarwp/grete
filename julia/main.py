...
def Historia():
	...
	cenaCampo.vai()
	jogador_defutebol = Elemento(img = "https://png.pngtree.com/element_origin_min_pic/16/09/10/1357d39a3fa4fe0.jpg", tit = "Jogador", style = dict (top = 60, left = 150 , height = 150, width = 50))
